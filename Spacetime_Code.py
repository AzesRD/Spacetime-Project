...
def main():
    ...
    dist, mean_dist, std_dist, cov_dist= distance_bw_2objs(simpleVersion, "Cool Cat", "Hobbes")
    print("\n" +"The distance between the two objects at each point in time is")
    print(dist)
    
    # distance matrix for a specific date
    dist_matrix= distance_matrix(simpleVersion, "2019-01-01 00:00:00")
    print("\n" + "The distance between each objects is")
    print(dist_matrix)
